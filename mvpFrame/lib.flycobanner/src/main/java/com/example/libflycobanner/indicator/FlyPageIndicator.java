package com.example.libflycobanner.indicator;
...
import com.example.libflycobanner.indicator.base.PageIndicator;
import com.nineoldandroids.view.ViewHelper;
import com.example.libflycobanner.R;
import java.util.ArrayList;

public class FlyPageIndicator extends LinearLayout implements PageIndicator {
    ...
    public FlyPageIndicator(Context context) {
        this(context, null);
    }

    public FlyPageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.FlyPageIndicator);
        indicatorWidth = ta.getDimensionPixelSize(R.styleable.FlyPageIndicator_fpi_width, dp2px(6));
        indicatorHeight = ta.getDimensionPixelSize(R.styleable.FlyPageIndicator_fpi_height, dp2px(6));
        indicatorGap = ta.getDimensionPixelSize(R.styleable.FlyPageIndicator_fpi_gap, dp2px(8));
        cornerRadius = ta.getDimensionPixelSize(R.styleable.FlyPageIndicator_fpi_cornerRadius, dp2px(3));
        strokeWidth = ta.getDimensionPixelSize(R.styleable.FlyPageIndicator_fpi_strokeWidth, dp2px(0));
        strokeColor = ta.getColor(R.styleable.FlyPageIndicator_fpi_strokeColor, Color.parseColor("#ffffff"));
        isSnap = ta.getBoolean(R.styleable.FlyPageIndicator_fpi_isSnap, false);

        int selectColor = ta.getColor(R.styleable.FlyPageIndicator_fpi_selectColor, Color.parseColor("#ffffff"));
        int unselectColor = ta.getColor(R.styleable.FlyPageIndicator_fpi_unselectColor, Color.parseColor("#88ffffff"));
        int selectRes = ta.getResourceId(R.styleable.FlyPageIndicator_fpi_selectRes, 0);
        int unselectRes = ta.getResourceId(R.styleable.FlyPageIndicator_fpi_unselectRes, 0);
        ta.recycle();

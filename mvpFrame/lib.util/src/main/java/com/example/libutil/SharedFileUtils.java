...
public class SharedFileUtils {
    ...
    public static final String BOTTOM_CURRENT_FRAGMENT_TAB = "BOTTOM_CURRENT_FRAGMENT_TAB";
    public static final String TOP_CURRENT_FRAGMENT_TAB = "TOP_CURRENT_FRAGMENT_TAB";
